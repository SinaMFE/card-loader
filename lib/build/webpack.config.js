...
var config = require('webpack-marauder/config');
...
// 压缩配置
var compress = Object.assign(config.compress, maraConf.compress);
/**
 * 生成生产配置
...
export default function (resource) {
    ...
    var entry = path.resolve(__dirname, './cardLoader.js') + "!" + resource;
